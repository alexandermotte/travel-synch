...
export const legalNoticeTranslations: Record<LegalLang, LegalNoticeContent> = {
  en: {
    ...
    title: "Legal Notice",
    sections: [
      { heading: "Website", paragraphs: ["trip-sorted.com"] },
      ...
      { heading: "Contact", paragraphs: [
        ...
        "Email address: contact@trip-sorted.com",
  ...
  fr: {
    ...
    sections: [
      { heading: "Site web", paragraphs: ["trip-sorted.com"] },
      ...
      { heading: "Contact", paragraphs: [
        ...
        "Adresse email : contact@trip-sorted.com",
  ...
  de: {
    ...
    sections: [
      ...
      { heading: "Kontakt", paragraphs: [
        ...
        "E-Mail: contact@trip-sorted.com",
  ...
  es: {
    ...
    title: "Aviso Legal",
    sections: [
      { heading: "Sitio web", paragraphs: ["trip-sorted.com"] },
      ...
      { heading: "Contacto", paragraphs: [
        ...
        "Correo electrónico: contact@trip-sorted.com",
  ...
  it: {
    ...
    title: "Avviso Legale",
    sections: [
      { heading: "Sito web", paragraphs: ["trip-sorted.com"] },
  ...
  el: {
    ...
    sections: [
      { heading: "Ιστοσελίδα", paragraphs: ["trip-sorted.com"] },
