...
export const subscriptionTermsTranslations: Record<LegalLang, SubscriptionTermsContent> = {
  en: {
    ...
    cancelHow: (link) => <>To cancel your subscription, please contact our customer support by phone at +4420 3936 2491, by email at contact@trip-sorted.com or through our contact form by following {link}</>,
  ...
  fr: {
    ...
    cancelHow: (link) => <>Pour résilier votre abonnement, veuillez contacter notre service client par téléphone au +4420 3936 2491, par email à contact@trip-sorted.com ou via notre formulaire de contact en suivant {link}</>,
  ...
  de: {
    ...
    cancelHow: (link) => <>Um Ihr Abonnement zu kündigen, kontaktieren Sie bitte unseren Kundendienst telefonisch unter +4420 3936 2491, per E-Mail an contact@trip-sorted.com oder über unser Kontaktformular unter {link}</>,
  ...
  pt: {
    ...
    cancelHow: (link) => <>Para cancelar a sua subscrição, contacte o nosso apoio ao cliente por telefone para +4420 3936 2491, por email para contact@trip-sorted.com ou através do nosso formulário de contacto em {link}</>,
  ...
  es: {
    ...
    cancelHow: (link) => <>Para cancelar su suscripción, contacte con nuestro servicio de atención al cliente por teléfono al +4420 3936 2491, por email a contact@trip-sorted.com o a través de nuestro formulario de contacto en {link}</>,
  ...
  it: {
    ...
    cancelHow: (link) => <>Per cancellare il tuo abbonamento, contatta il nostro servizio clienti telefonicamente al +4420 3936 2491, via email a contact@trip-sorted.com o tramite il nostro modulo di contatto su {link}</>,
  ...
  el: {
    ...
    cancelHow: (link) => <>Για να ακυρώσετε τη συνδρομή σας, επικοινωνήστε με την υποστήριξη πελατών μας τηλεφωνικά στο +4420 3936 2491, μέσω email στο contact@trip-sorted.com ή μέσω της φόρμας επικοινωνίας στο {link}</>,
